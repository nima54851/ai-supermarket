...
export function registerExtractPiiCommand(program) {
    program
        .command("extract_pii <text>")
        .alias("extract-pii")
        .description("Extract PII entities from text (persons, emails, phone numbers, etc.).")
        .option("-t, --threshold <number>", "Confidence threshold for entity extraction.", String(DEFAULT_THRESHOLD))
        .option("-c, --categories <list>", "Comma-separated list of PII categories to extract.", DEFAULT_CATEGORIES.join(","))
...
//# sourceMappingURL=extractPii.js.map