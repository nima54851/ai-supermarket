...
export function registerExtractJsonCommand(program) {
    program
        .command("extract_json <text>")
        .alias("extract-json")
        .description("Extract structured JSON from text according to a provided schema.")
        .requiredOption("-s, --schema <json>", 'Schema as a JSON string, e.g. \'{"contact":["name::str::Full name","email::str::Email address"]}\'')
