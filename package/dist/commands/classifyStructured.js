...
export function registerClassifyStructuredCommand(program) {
    program
        .command("classify_structured <text>")
        .alias("classify-structured")
        .description("Classify text against a structured schema of categories and labels.")
        .requiredOption("-s, --schema <json>", 'JSON object mapping category name to allowed labels, e.g. \'{"sentiment":["positive","negative","neutral"]}\'')
...
//# sourceMappingURL=classifyStructured.js.map