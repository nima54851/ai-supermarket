...
export function registerGenerateFollowupsCommand(program) {
    program
        .command("generate_followups <text>")
        .alias("generate-followups")
        .description("Generate contextual follow-up questions with the ZeroGPU followup edge model.")
        .action(async (text) => {
...
//# sourceMappingURL=generateFollowups.js.map