...
export function registerClassifyZeroShotCommand(program) {
    program
        .command("classify_zero_shot <text>")
        .alias("classify-zero-shot")
        .description("Zero-shot classify text against a set of candidate labels using DeBERTa v3.")
        .option("-l, --label <label>", "Candidate label (repeatable).", collectLabel, [])
        .option("--labels <labels>", "Comma-separated list of candidate labels (alternative to repeating --label).")
...
//# sourceMappingURL=classifyZeroShot.js.map