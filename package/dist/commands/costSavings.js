...
export function registerCostSavingsCommand(program) {
    program
        .command("cost_savings")
        .alias("cost-savings")
        .description("Show how much you've saved by routing tasks to ZeroGPU instead of Claude.")
...
//# sourceMappingURL=costSavings.js.map