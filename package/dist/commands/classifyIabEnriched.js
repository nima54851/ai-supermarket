...
export function registerClassifyIabEnrichedCommand(program) {
    program
        .command("classify_iab_enriched <text>")
        .alias("classify-iab-enriched")
        .description("Classify text with the IAB enriched edge model (audience, topics, keywords, intent).")
        .action(async (text) => {
...
//# sourceMappingURL=classifyIabEnriched.js.map